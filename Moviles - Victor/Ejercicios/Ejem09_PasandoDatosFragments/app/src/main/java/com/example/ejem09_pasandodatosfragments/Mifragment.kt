...
import com.example.ejem09_pasandodatosfragments.databinding.FragmentMiBinding
...
class MiFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding.bPasarDatoFragment2.setOnClickListener {

            val sacoDeDatos:Bundle = Bundle()
            sacoDeDatos.putString("dato", binding.tietDato.text.toString())

            parentFragmentManager.setFragmentResult("datoAEnviar", sacoDeDatos)
        }
